  ...
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionName" :options="options" :where="where" page-data="replace"
		...
		field="cz_id{title},user_id{nickname},comment_content,like_count,comment_date"
        ...
        <uni-table :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
              <uni-th align="center">评论所在创作</uni-th>  
			  <uni-th align="center">评论用户</uni-th> 
			  <uni-th align="center">评论内容</uni-th>  
			  <uni-th align="center">点赞量</uni-th>  
			  <uni-th align="center">评论时间</uni-th>  
			  <uni-th width="204" align="center">操作</uni-th>
          </uni-tr>
          <uni-tr v-for="(item,index) in data" :key="index">
               <uni-td align="center">{{item.cz_id[0].title}}</uni-td>  
			   ...
			   <uni-td align="center">
				   <uni-dateformat :date="item.comment_date" :threshold="[0, 0]" />
			   </uni-td>     
            <uni-td align="center">
              <view class="uni-group">
